...
\begin{figure*}[t]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=4.0cm,keepaspectratio]{tps_heatmap_HKUSTQLAB-6000ADA_cpu_float32_sdpa_cache-on_none_SmolLM2-360M.png}
    \par\vspace{0.5mm}
    {\footnotesize (a) CPU FP32, batches 1--16}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=4.0cm,keepaspectratio]{tps_heatmap_HKUSTQLAB-6000ADA_cuda_bfloat16_sdpa_cache-on_none_SmolLM2-360M.png}
    \par\vspace{0.5mm}
